...
public class Morceau {
	...
	public Morceau(String tM, Album aM, Artiste artM, Set<Genre> gM, Set<Playlist> pM, int annM) {
		this.codeMorceau = -1;
		this.titreMorceau = tM;
		this.albumMorceau = aM;
		this.artisteMorceau = artM;
		this.genresMorceau = gM;
		this.playlistsMorceau = pM;
		this.anneeMorceau = annM;
		
		this.etatMetier = Bibliotheque.CREE;
	}
	...
	public boolean presencePlaylistMorceau(Playlist p) {
		return this.playlistsMorceau.contains(p);
	}
