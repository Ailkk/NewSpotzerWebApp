...
public class Playlist {
	...
	public Playlist(String titrePlaylist,
	...
	public String toString() {
		return "Playlist [codePlaylist=" + codePlaylist + ", morceauxPlaylist=" + morceauxPlaylist + ", titrePlaylist="
				+ titrePlaylist + ", descriptionPlaylist=" + descriptionPlaylist + "]";
	}
